...
\begin{description}
    ...
    if all samples belonging to a language were assigned
 		...
 		\begin{equation}
		Precision = \frac
		{\abs{\{\text{samples belonging to a language which were correctly identified as belonging to said language}\}}}
		{\abs{\{\text{samples belonging to a language which were correctly identified as belonging to said language}\} \cup \{\text{samples belonging to a language which were identified as belonging to another language}\}}}
		\end{equation}  
		
		\begin{equation}
		Recall = \frac
		{\abs{\{\text{samples belonging to a language which were correctly identified as belonging to said language}\}}}
		{\abs{\{\text{samples belonging to a language which were correctly identified as belonging to said language}\} \cup \{\text{samples belonging to a language which were incorrectly identified as not belonging to said language}\}}}
		\end{equation}      
