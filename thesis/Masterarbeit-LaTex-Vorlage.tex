...
\titlehead{
\centering\includegraphics{hpi_logo_cmyk_wb_sl2}
...
\date{2 June 2017\bigskip}
\publishers{
\textbf{Supervisors} \\ Prof. Dr. Christoph Meinel \\ Dr. Haojin Yang \\
\bigskip
...
\begin{document}
    ...
    % Inhaltsverzeichnis
    \cleardoublepage % auf neuer Seite
    \pagestyle{empty}
